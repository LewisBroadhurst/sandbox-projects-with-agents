...
This is an [Nx](https://nx.dev) monorepo used to host several small projects. Each project lives under `apps/` as its own Nx project.

Run `npx nx graph` to visually explore the workspace.
...
# React library
npx nx g @nx/react:lib apps/my-lib
```
