import type { Blessing, BlessingId, Building, BuildingId, GameState, Milestone, ResourceKey, Terrain } from './types';
...
export const RESOURCE_ORDER: ResourceKey[] = ['gold', 'favor', 'wood', 'stone', 'copper', 'bronze', 'fish', 'grain', 'bread'];
